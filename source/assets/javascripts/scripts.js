...
$(document).ready(function() {
    ...
    function openModal(event) {
        ...
        $('.modal').removeClass('modal--hiding modal--hidden');
        Cookies.set('hide_modal', 'false');
    }
    ...
    function closeModal(event) {
        ...
        $('.modal').toggleClass('modal--hiding');

        // set cookie to prevent modal from popping up on other pages
    ...
    // check cookies to see if modal should be closed on page load
    if (Cookies.get('hide_modal') == 'true') {
        closeModal(null);
    } else {
        openModal(null);
    }
    ...
    $('.modal__open-btn').click(function(event) {
        openModal(event);
    })
});